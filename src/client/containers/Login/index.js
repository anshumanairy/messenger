...
import { loginFieldsData } from "./constants";
...
const Login = (props) => {
  ...
  const [fieldsData, setFieldsData] = useState([...loginFieldsData]);
  ...
  return (
    <form onSubmit={handleLoginSubmit}>
      <LoginWrapper className="dF fdC">
        <Typography className="taC">WELCOME BACK</Typography>
            ...
            return (
              <InputFieldWrapper className="dF fdC" key={index}>
                <p className="dF jcsB">
                  ...
                  {field?.type === "password" && (
                    <label className="cP hU forgot-password">
                      Forgot Password?
                    </label>
                  )}
                </p>
                <div className="pR">
                  ...
                  {field?.type === "password" && (
                    <>
                      ...
                      />
                      {loginData?.showPassword && <span className="cross" />}
                    </>
                  )}
                </div>
              </InputFieldWrapper>
